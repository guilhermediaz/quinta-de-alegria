        ...
        <div class="px-6 pt-6 lg:max-w-2xl lg:pl-8 lg:pr-0">
          <nav class="flex items-center justify-between lg:justify-start" aria-label="Global">
            <a href="#" class="-m-1.5 p-1.5">
              ...
              <img alt="Your Company" class="h-16 w-auto" src="~/assets/images/quintal_logo.svg" />
            </a>
        ...
        <div class="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
          ...
          <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
              ...
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Casa de festas e peripécias!</h1>
              <p class="mt-6 text-lg leading-8 text-gray-600">Somos uma casa de festas e peripécias diferente de tudo que você já viu, com uma proposta inovadora: o resgate das antigas tradições e brincadeiras da nossa época de criança.</p>
