...
-->
<template>
  <div class="relative isolate bg-indigo-700">
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <h2 class="text-3xl font-bold tracking-tight text-white">Solicite seu orçamento</h2>
          <p class="mt-6 text-lg leading-8 text-white">Está pronto para dar vida à festa dos sonhos? Preencha o formulário com seus detalhes e informações do evento. Nossa equipe está ansiosa para planejar uma celebração personalizada que será lembrada por todos. Vamos transformar juntos essa ocasião em uma memória inesquecível. Solicite seu orçamento agora!</p>
          <dl class="mt-10 space-y-4 text-base leading-7 text-white">
            <div class="flex gap-x-4">
              <dt class="flex-none">
                <span class="sr-only">Address</span>
                <BuildingOffice2Icon class="h-7 w-6 text-yellow-400" aria-hidden="true" />
              </dt>
              <dd>R. Prof. Augusto Rusch, 40<br />Praia de Itaparica, Vila Velha -ES</dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
                <span class="sr-only">Telephone</span>
                <PhoneIcon class="h-7 w-6 text-green-400" aria-hidden="true" />
              </dt>
              <dd><a class="hover:text-white" href="tel:27997090791">(27) 9 9709-0791</a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
                <span class="sr-only">Email</span>
                <EnvelopeIcon class="h-7 w-6 text-orange-400" aria-hidden="true" />
              </dt>
              <dd><a class="hover:text-white" href="mailto:contato@quintaldealegria.com.br">contato@quintaldealegria.com.br</a></dd>
            </div>
          </dl>
        </div>
      </div>
